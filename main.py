...
def ant_colony(coordinates):
    ...
    optimized_route = ant_colony_optimization(distance_matrix, num_ants=10, num_iterations=200, pheromone_evaporation=0.5, pheromone_constant=1.0, alpha=1.0, beta=2.0)
