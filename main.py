...
def main():
    ...
    num_ants = 16, num_iterations = 150,
    pheromone_evaporation = 0.4, pheromone_constant = 3.5, alpha = 1.0, beta = 2.0
...
def ant_colony(coordinates):
    ...
    optimized_route = ant_colony_optimization(distance_matrix, num_ants=16, num_iterations=150,
                                              pheromone_evaporation=0.4, pheromone_constant=3.5, alpha=1.0, beta=2.0)
